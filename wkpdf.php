...
$pg=array(1,1); // pageNum, siman, sif
...
$plen=0;
  for($sn=1; $sn<=$length; $sn++){
    $url = "https://www.sefaria.org/api/texts/Shulchan_Arukh%2C_Yoreh_De'ah.$pg[1]";
    ...
    //sections
      ...
      $sefer=$sefer."<div style='text-align: justify; padding-bottom: 15px;'><span style='font-size: 25px;'><b>".numToHebrew($pg[1])."</b></span>$sif</div>";//	
    }
